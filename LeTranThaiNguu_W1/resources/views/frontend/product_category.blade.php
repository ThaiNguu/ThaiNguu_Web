            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="bg-info p-3 mb-4 rounded">
                        <h3 class="fs-5 py-3 text-center text-light">{{ $row->name ?? 'TẤT CẢ SẢN PHẨM' }}</h3>
                    </div>
...
<script>
    ...
    if (view === 'list') {
        window.location.href = `{{ url('danh-muc') }}/${categorySlug}/list?` + urlParams.toString();
    } else if (view === 'grid') {
        window.location.href = `{{ url('danh-muc') }}/${categorySlug}/grid?` + urlParams.toString();
    }
}
