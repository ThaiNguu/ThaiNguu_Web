            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="bg-info p-3 mb-4 rounded">
                        <h3 class="fs-5 py-3 text-center text-light">TẤT CẢ SẢN PHẨM TRONG THƯƠNG HIỆU {{ $brand->name }}</h3>
                    </div>
                    <section class="hdl-maincontent py-2">
                        <div class="row">
                            <div class="col-lg-3 mb-3">
                                <label for="filter" class="form-label">Lọc:</label>
                            ...
                            <div class="col-lg-6 d-flex justify-content-end align-items-center">
                                <a href="{{ route('site.product.brand.grid', ['slug' => $brand->slug] + request()->query()) }}" class="btn btn-secondary me-2 bg-warning">Grid view</a>
                                <a href="{{ route('site.product.brand.list', ['slug' => $brand->slug] + request()->query()) }}" class="btn btn-secondary bg-warning">List view</a>
                            </div>
                        </div>
                    </section>
